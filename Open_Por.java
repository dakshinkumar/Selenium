...
System.setProperty("webdriver.chrome.driver","/home/dakshinkumartk/Videos/chromedriver");
		...
		System.out.println("Access channel is " +myString);
		
        driver.findElement(By.xpath("//*[@id=\'s2id_customerSelect\']/a")).click();
        driver.findElement(By.xpath("//*[@id='select2-drop']/div/input")).sendKeys(splitString[0]+Keys.ENTER);
        Thread.sleep(15000);
        ...
        driver.findElement(By.xpath("//*[@id=\"credentialTbl_wrapper\"]/div[1]/div[1]/div/div/div[2]/div[1]/div/div[3]/div[1]/input")).sendKeys(myString);
